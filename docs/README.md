...
| [纯标量检索持久化补充](design/scalar-query-persistence.md) | Scalar-only 模式、索引定义和文本范围读取 |
...
| 文档 | 说明 |
|------|------|
| [非向量检索实施记录](development/vectorlite-non-vector-retrieval-implementation-2026-07-23.md) | 七批次验收与完成状态 |
| [工作交接](development/HANDOVER.md) | 当前基线、遗留问题和下一轮计划 |
